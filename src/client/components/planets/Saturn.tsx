...
import { saturnVertex, saturnFragment } from '@/client/shaders/saturn';
import { ringVertex, ringFragment } from '@/client/shaders/saturnRing';
import { atmosphereVertex, atmosphereFragment } from '@/client/shaders/atmosphere';
